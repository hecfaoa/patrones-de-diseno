...
import { ColorAzul } from "./class/colorAzul.js";
import { ColorRojo } from "./class/ColorRojo.js";
import { ColorVerde } from "./class/ColorVerde.js";
...
const rojo = new ColorRojo();
const azul = new ColorAzul();  

const verde = new ColorVerde();

const circuloRojo = new Circulo(rojo);
const circuloAzul = new Circulo(azul);  
const cuadradoRojo = new Cuadrado(rojo);
const cuadradoVerde = new Cuadrado(verde);

circuloRojo.dibujar(); // Dibujando un círculo. Aplicando color rojo
circuloAzul.dibujar(); // Dibujando un círculo. Aplicando color azul
cuadradoRojo.dibujar(); // Dibujando un cuadrado. Aplicando color rojo
cuadradoVerde.dibujar(); // Dibujando un cuadrado. Aplicando color verde
